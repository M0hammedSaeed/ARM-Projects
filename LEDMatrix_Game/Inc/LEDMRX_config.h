 ...
 */
#define HLEDMRX_ROW0_PIN	 HLEDMRX_ROW_PORT, MGPIO_PIN1
#define HLEDMRX_ROW1_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN2
#define HLEDMRX_ROW2_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN3
#define HLEDMRX_ROW3_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN4
#define HLEDMRX_ROW4_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN5
#define HLEDMRX_ROW5_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN6
#define HLEDMRX_ROW6_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN7
#define HLEDMRX_ROW7_PIN     HLEDMRX_ROW_PORT, MGPIO_PIN8
